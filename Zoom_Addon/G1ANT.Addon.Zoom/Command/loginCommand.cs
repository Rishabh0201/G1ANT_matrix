...
{
    [Command(Name = "zoom.login", Tooltip = "This command is used to login into zoom account.")]
    public class zoomloginCommand : Command
    {
        public zoomloginCommand(AbstractScripter scripter) : base(scripter)
        {
