...
{
    [Command(Name = "facebookapp.open", Tooltip = "This command initialises appium server.")]
    public class OpenCommand : Language.Command
    {
        ...
        {
            [Argument(Required = true, Tooltip = "com.facebook.browser.lite.BrowserLiteBottomSheetActivity")]
            public TextStructure AppActivity { get; set; } = new TextStructure("");

            [Argument(Required = true, Tooltip = "com.facebook.katana")]
