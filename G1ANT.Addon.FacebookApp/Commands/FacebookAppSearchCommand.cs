...
{
    [Command(Name = "facebookapp.search", Tooltip = "This command Search a given element in Facebook app")]
    public class FacebookAppSearchCommand : Language.Command
    {
        ...
        public FacebookAppSearchCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments)
        {
            ...
            Thread.Sleep(500);
            arguments.Search.Value = "com.facebook.android:id/lookup_edittext";
