using G1ANT.Addon.Appium;
using OpenQA.Selenium;
using OpenQA.Selenium.Appium.Android;
using OpenQA.Selenium.Support.UI;
using System;

namespace G1ANT.Addon.LineApp
{
    public static class ElementHelper
    {
        ...
        private static AndroidElement GetElementByAccessibilityId(string accessibilityId)
        {
            ...
            try
            {
                wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementIsVisible(By.XPath("//*[contains(@content-desc,\"" + accessibilityId + "\")]")));
        ...
        private static AndroidElement GetElementByPartialId(string partialId)
        {
            ...
            try
            {
                wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementIsVisible(By.XPath("//*[contains(@content-desc,\"" + partialId + "\")]")));
