...
```G1ANT
flipkart.search type ⟦text⟧
```

## Description
This command search any product on Flipkart.

| Argument | Type | Required | Default Value | Description |
| -------- | ---- | -------- | ------------- | ----------- |
|`text`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | yes |  | Type which product you want to search |
...
In the following example the browser waits until Flipkart webpage is loaded, After 5 second starts login in Flipkart acount using given credential. after 5 second start searching given text in the search box:
...
delay 5
flipkart.search "headphone" search
