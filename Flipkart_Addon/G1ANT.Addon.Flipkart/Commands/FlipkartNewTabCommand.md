...
This command adds a new tab of 'www.Flipkart.com' in to the current browser.

| Argument | Type | Required | Default Value | Description |
| -------- | ---- | -------- | ------------- | ----------- |
|`url`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | no| www.flipkart.com | Webpage address to load |
...
In the following example the browser waits until the first webpage is loaded, but then the robot opens Flipkart and immediately starts loading another Flipkart tab, because of the `nowait true` argument:
