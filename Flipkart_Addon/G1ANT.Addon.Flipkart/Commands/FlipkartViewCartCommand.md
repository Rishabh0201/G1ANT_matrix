...
## Description
This command is used to see a product in a cart of flipkart.
...
In the following example the browser waits until Flipkart webpage is loaded, After 5 second starts login in Flipkart acount using given credential. after 5 second open offer page in Flipkart:
