...
{
    [Command(Name = "flipkart.newtab", Tooltip = "This command adds a new tab of 'www.Flipkart.com' in to the current browser")]
    public class FlipkartNewTabCommand : Command
    {
        ...
        public FlipkartNewTabCommand(AbstractScripter scripter) : base(scripter)
        {
        }
