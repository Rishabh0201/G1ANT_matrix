...
```G1ANT
flipkart.login type ⟦phone⟧ type ⟦pword⟧
```

## Description
"This command login in Flipkart.
...
In the following example the browser waits until Flipkart webpage is loaded,and After 5 second starts login in Flipkart acount using given credential:

```G1ANT
flipkart.open 
delay 5
flipkart.login phone xxxxxx pword xxxx search
