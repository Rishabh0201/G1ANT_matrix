...
{
    [Command(Name = "droidyoutube.trending", Tooltip = "This command opens trending page on Youtube")]
    public class trendingyoutubedroidCommand : Language.Command
    {
        ...
        public trendingyoutubedroidCommand(AbstractScripter scripter) : base(scripter)
        {
