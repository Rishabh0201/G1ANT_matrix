...
{
    [Command(Name = "droidyoutube.library", Tooltip = "This command opens library page on Youtube")]
    public class libraryyoutubedroidCommand : Language.Command
    {
        ...
        public libraryyoutubedroidCommand(AbstractScripter scripter) : base(scripter)
        {
