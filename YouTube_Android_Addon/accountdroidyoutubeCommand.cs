...
{
    [Command(Name = "droidyoutube.account", Tooltip = "This command opens account page on Youtube")]
    public class settingyoutubedroidCommand : Language.Command
    {
        ...
        public settingyoutubedroidCommand(AbstractScripter scripter) : base(scripter)
        {
