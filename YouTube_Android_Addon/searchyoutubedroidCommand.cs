...
{
    [Command(Name = "droidyoutube.search", Tooltip = "This command opens search page on Youtube")]
    public class searchyoutubedroidCommand : Language.Command
    {
        public class Arguments : CommandArguments
        {
            [Argument(Required = true, Tooltip = "Provide name of the capaility")]
            public TextStructure Search { get; set; } = new TextStructure("com.google.android.youtube:id/menu_item_1");

            [Argument(Required = true, Tooltip = "Provide element ID")]
            public TextStructure By { get; set; } = new TextStructure("Id");
            [Argument(Required = true, Tooltip = "Provide the search element")]
            public TextStructure searchobject { get; set; } = new TextStructure("");
        ...
        public searchyoutubedroidCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments)
        {
            ...
            ElementHelper.GetElement(arguments.By.Value, arguments.Search.Value).SendKeys(arguments.searchobject.Value);
