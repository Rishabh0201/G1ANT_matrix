...
{
    [Command(Name = "droidyoutube.notification", Tooltip = "This command opens notification page on Youtube")]
    public class notificationyoutubedroidCommand : Language.Command
    {
        ...
        public notificationyoutubedroidCommand(AbstractScripter scripter) : base(scripter)
        {
