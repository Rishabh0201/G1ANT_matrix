...
```G1ANT
snapchat.download phnnumber
```

## Description
This command is used to  download snapchat for android as well as IOS
...
addon snapchat version 1.0.0.0
snapchat.open search 
snapchat.download phnnumber ♥credential⟦snapchat:phn⟧ search
