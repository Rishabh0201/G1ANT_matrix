...
```G1ANT
irctc.login username password
```

## Description
This command is used to login on IRCTC Website.
...
irctc.open search
irctc.login username ♥credential⟦irctc:login⟧ password ♥credential⟦irctc:pass⟧ search
