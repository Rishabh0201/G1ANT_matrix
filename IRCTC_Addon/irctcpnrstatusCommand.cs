...
{
    [Command(Name = "irctc.pnrstatus", Tooltip = "This command checks the pnr status of trains on  irctc ")]
    public class irctcpnrCommand : Command
    {
        public irctcpnrCommand(AbstractScripter scripter) : base(scripter)
        {
