...
{
    [Command(Name = "rapidoapp.backbutton", Tooltip = "This command clicks on a back button of android phone.")]
    public class RapidoAppBackButtonCommand : Language.Command
    {
        ...
        public RapidoAppBackButtonCommand(AbstractScripter scripter) : base(scripter)
        {
