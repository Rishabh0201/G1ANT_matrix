...
This command is used to closes the current tab in the current browser in which messenger is opened.
...
In the following script the robot opens messenger tabs in Chrome, and after 5 seconds the current tab is closed.
