...
```G1ANT
messenger.login type ⟦phone⟧ type ⟦pword⟧
```

## Description
This command login in Messenger web browser.

| Argument | Type | Required | Default Value | Description |
| -------- | ---- | -------- | ------------- | ----------- |
|`phone`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | yes |  | Phone number |
...
In the following example the browser waits until Messenger webpage is loaded,and After 5 second starts login in Messenger acount using given credential:

```G1ANT
messenger.open 
delay 5
messenger.login phone xxxxxx pword xxxx search
