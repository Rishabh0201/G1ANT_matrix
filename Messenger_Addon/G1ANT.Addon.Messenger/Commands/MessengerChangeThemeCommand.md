...
## Description
This command change Theme of message on Messenger web.
...
In the following example the browser waits until Messenger webpage is loaded, After 5 second starts login in Messenger acount using given credential. after 5 second change the theme in Messenger:
