...
## Description
This command is used to write message to already opened friend on messenger.
...
In the following example the browser waits until Messenger webpage is loaded, After 5 second starts login in Messenger acount using given credential. after 5 second write message to already opened friend on messenger:

```G1ANT
messenger.open 
delay 5
messenger.login phone xxxxxx Pass xxxx search
delay 5
messenger.writemessage
