...
{
    [Command(Name = "zoomapp.setting", Tooltip = "This command helps you to set setting of Zoom App")]
    public class ZoomAppSettingCommand : Language.Command
    {
        ...
        public ZoomAppSettingCommand(AbstractScripter scripter) : base(scripter)
        {
