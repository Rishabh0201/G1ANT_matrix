...
{
    [Command(Name = "naukriapp.open", Tooltip = "This command initialises appium server.")]
    public class OpenCommand : Language.Command
    {
        ...
        {
            [Argument(Required = true, Tooltip = "com.naukri.dashboard.view.NaukriSplashScreen")]
            public TextStructure AppActivity { get; set; } = new TextStructure("");

            [Argument(Required = true, Tooltip = "naukriApp.appModules.login")]
