...
```G1ANT
linked.message to messagevalue 
```

## Description
This command is used to message anyone on LinkedIn
...
linked.message to ‴name‴ messagevalue ‴Hello this is robot message‴ search  
