...
{
    [Command(Name = "webexapp.open", Tooltip = "This command initialises webex appium server.")]
    public class OpenCommand : Language.Command
    {
        ...
        {
            [Argument(Required = true, Tooltip = "com.cisco.webex.meetings.ui.premeeting.welcome.WebExMeeting")]
            public TextStructure AppActivity { get; set; } = new TextStructure("");

            [Argument(Required = true, Tooltip = "com.cisco.webex.meetings")]
            public TextStructure AppPackage { get; set; } = new TextStructure("");

            [Argument(Required = false, Tooltip = "UiAutomator2")]
            public TextStructure AutomationName { get; set; } = new TextStructure("UiAutomator2");

            [Argument(Required = true, Tooltip = "Android")]
