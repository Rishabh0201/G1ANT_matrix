...
{
    [Command(Name = "tumblrapp.follow", Tooltip = "This command helps you to follow a account in Tumblr App")]
    public class TumblrAppFollowCommand : Language.Command
    {
        ...
        public TumblrAppFollowCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public void Execute(Arguments arguments)
        {
            ...
            Thread.Sleep(100);            
            arguments.Search.Value = "com.tumblr:id/icon_action";
            arguments.By.Value = "id";
            ElementHelper.GetElement(arguments.By.Value.ToLower(), arguments.Search.Value).Click();
            Thread.Sleep(2000);
