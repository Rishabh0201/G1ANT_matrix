...
{
    [Command(Name = "tumblrapp.inbox", Tooltip = "This command helps you to see inbox of  Tumblr App")]
    public class TumblrAppInboxCommand : Language.Command
    {
        ...
        public TumblrAppInboxCommand(AbstractScripter scripter) : base(scripter)
        {
