...
{
    [Command(Name = "pinterestapp.open", Tooltip = "This command initialises appium server.")]
    public class OpenCommand : Language.Command
    {
        ...
        {
            [Argument(Required = true, Tooltip = "com.pinterest.activity.PinterestActivity")]
            public TextStructure AppActivity { get; set; } = new TextStructure("");

            [Argument(Required = true, Tooltip = "com.pinterest")]
