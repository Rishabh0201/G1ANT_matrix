...
## Description
This command logout from pinterest web.
...
> **Note:** the `pinterest.` commands require opening a browser with the `pinterest.open` command first then login in your account.
## Example
In the following example the browser waits until pinterest webpage is loaded, but then the robot opens facebook and After 5 second starts login in pinterest acount using given credential. After 5 secon it logout from your Account:
```G1ANT
pinterest.open 
delay 5
