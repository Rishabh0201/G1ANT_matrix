...
## Description
This command is used to login in pinterest
...
```G1ANT
addon pinterest version 1.0.0.0
pinterest.open search 
pinterest.login email ♥credential⟦pinterest:mail⟧ password ♥credential⟦pinterest:pass⟧ search
