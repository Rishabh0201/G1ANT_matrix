...
{
    [Command(Name = "swiggy.search", Tooltip = "This command searches resturants provided in arguments ")]
    public class searchresturantCommand : Command
    {
        public searchresturantCommand(AbstractScripter scripter) : base(scripter)
        {
