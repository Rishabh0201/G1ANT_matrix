...
## Description
This command logout from line web.
...
> **Note:** the `line.` commands require opening a browser with the `line.open` command first then login in your account.
## Example
In the following example the browser waits until line webpage is loaded, but then the robot opens facebook and After 5 second starts login in line acount using given credential. After 5 secon it logout from your Account:
