...
{
    [Command(Name = "olacabapp.open", Tooltip = "This command initialises (open) OlaCab app.")]
    public class OpenCommand : Language.Command
    {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure AppActivity { get; set; } = new TextStructure("com.olacabs.lite.SplashActivity");

            [Argument(Required = true, Tooltip = "App Package")]
            public TextStructure AppPackage { get; set; } = new TextStructure("com.olacabs.lite");
        ...
        public void Execute(Arguments arguments)
        {
            ...
            ElementHelper.GetElement(arguments.By.Value.ToLower(), arguments.Search.Value).Click();
            Thread.Sleep(5000);
            arguments.Search.Value = "Continue to next step";
            arguments.By.Value = "accessibilityid";
            ElementHelper.GetElement(arguments.By.Value.ToLower(), arguments.Search.Value).Click();
            Thread.Sleep(5000);
