...
```G1ANT
microsoftteams.login email password
```

## Description
This command is used to login in microsoftteams.
...
```G1ANT
addon microsoftteams version 1.0.0.0
microsoftteams.open search 
microsoftteams.login email ♥credential⟦microsoftteams:mail⟧ password ♥credential⟦microsoftteams:pass⟧ search
