...
## Description
This command logout from facebook web.
...
> **Note:** the `facebook.` commands require opening a browser with the `facebook.open` command first then login in your account.
## Example

In the following example the browser waits until facebook webpage is loaded, but then the robot opens facebook and After 5 second starts login in facebook acount using given credential. After 5 secon it logout from your Account:
