...
This command opens a new instance of a chosen web browser and open quora in it.
...
|`url`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | no| www.quora.com | URL address of a webpage to be loaded |
...
This simple script opens chrome browser and runs a Google search for “quora”:
