...
## Description
This command shows all the notification which is available in Quora.
...
In the following example the browser waits until Quora webpage is loaded, After 5 second starts login in Quora acount using given credential. after 5 second open notification page on Quora:
