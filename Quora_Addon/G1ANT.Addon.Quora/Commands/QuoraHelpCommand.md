...
In the following example the browser waits until Quora webpage is loaded, After 5 second starts login in Quora acount using given credential. after 5 second open help page on Quora:
