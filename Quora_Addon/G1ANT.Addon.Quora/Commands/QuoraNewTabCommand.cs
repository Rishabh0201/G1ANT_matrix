...
{
    [Command(Name = "quora.newtab", Tooltip = "This command adds a new tab of 'www.Quora.in' in to the current browser")]
    public class QuoraNewTabCommand : Command
    {
        ...
        public QuoraNewTabCommand(AbstractScripter scripter) : base(scripter)
        {
        }
