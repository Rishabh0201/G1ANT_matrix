...
## Description
This command is used to land on OlaSelect web page.
...
In the following example the browser waits until Olacab webpage is loaded, After 5 second click on olaselect page on Olacab:
