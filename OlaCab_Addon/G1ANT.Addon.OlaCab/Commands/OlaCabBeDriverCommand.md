...
## Description
This command is used to see the offers for become a driver in OlaCab.
...
In the following example the browser waits until Olacab webpage is loaded, After 5 second click on be a driver page on Olacab:
