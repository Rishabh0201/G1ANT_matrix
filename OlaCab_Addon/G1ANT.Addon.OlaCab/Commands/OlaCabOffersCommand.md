...
## Description
This command is used to see the offers on OlaCab web page.
...
In the following example the browser waits until Olacab webpage is loaded, After 5 second click on Offers on Olacab:
