...
## Description
This command is used to land on career page of OlaCab.
...
In the following example the browser waits until Olacab webpage is loaded, After 5 second click on career page on Olacab:
