...
{
    [Command(Name = "olacab.open", Tooltip = "This command opens a new instance of a chosen web browser and open OlaCab in it.")]
    class OlaCabOpenCommand : Command
    {
        public OlaCabOpenCommand(AbstractScripter scripter) : base(scripter)
        {
        ...
        public class Arguments : CommandArguments
        {
            ...
            public TextStructure Url { get; set; } = new TextStructure("www.olacabs.com");
