...
This command opens a new instance of a chosen web browser and open amazon in it.
...
|`url`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | no| www.amazon.in | URL address of a webpage to be loaded |
