...
In the following example the browser waits until the first webpage is loaded, immediately starts loading another Tab of instagram, because of the `nowait true` argument:
