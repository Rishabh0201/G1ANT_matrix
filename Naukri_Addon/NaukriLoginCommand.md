...
```G1ANT
naukri.login email password
```

## Description
This command is used to login in naukri.
...
```G1ANT
addon naukri version 1.0.0.0
naukri.open search 
naukri.login email ♥credential⟦naukri:mail⟧ password ♥credential⟦naukri:pass⟧ search
