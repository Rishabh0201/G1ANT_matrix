...
## Description
This command is used to take help on Rapido web page.
...
In the following example the browser waits until Rapido webpage is loaded, After 5 second starts opening career page of Rapido. after 5 second open Help page on Rapido:
