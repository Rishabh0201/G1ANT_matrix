...
{
    [Command(Name = "rapido.newtab", Tooltip = "This command adds a new tab of 'www.Rapido.bike' in to the current browser")]
    public class RapidoNewTabCommand : Command
    {
        ...
        public RapidoNewTabCommand(AbstractScripter scripter) : base(scripter)
        {
        }
