...
## Description
This command is used to land on Home page of Rapido.
...
In the following example the browser waits until Rapido webpage is loaded, After 5 second starts opening career page of Rapido. after 5 second open home page on Rapido:
