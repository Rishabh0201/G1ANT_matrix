...
## Description
This command is used to land on help page of Uber web page.
...
In the following example the browser waits until Uber webpage is loaded, After 5 second starts opening blog page of Uber. after 5 second open Help page on Uber:
