...
## Description
This command is used to land on drive page of Uber web page.
...
In the following example the browser waits until Uber webpage is loaded, After 5 second starts opening drive page of Uber. after 5 second start opening NewsRoom page of Uber:
