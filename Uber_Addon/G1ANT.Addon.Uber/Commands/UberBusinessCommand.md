...
## Description
This command is used to land on business page of Uber web page.
...
In the following example the browser waits until Uber webpage is loaded, After 5 second starts opening business page of Uber. after 5 second start opening Blog page of Uber:
