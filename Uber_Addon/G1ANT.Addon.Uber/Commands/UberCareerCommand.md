...
## Description
This command is used to land on career page of Uber.
...
In the following example the browser waits until Uber webpage is loaded, After 5 second starts opening career page of Uber. after 5 second open Help page on Uber:
