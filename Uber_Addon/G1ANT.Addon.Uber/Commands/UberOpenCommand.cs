...
{
    [Command(Name = "uber.open", Tooltip = "This command opens a new instance of a chrome web browser and open Uber.com in it.")]
    class UberOpenCommand : Command
    {
        public UberOpenCommand(AbstractScripter scripter) : base(scripter)
        {
