...
## Description
This command is used to land on newsroom page of Uber web page.
...
In the following example the browser waits until Uber webpage is loaded, After 5 second starts opening business page of Uber. after 5 second start opening NewsRoom page of Uber:

```G1ANT
uber.open 
delay 5
uber.business search
delay 5
