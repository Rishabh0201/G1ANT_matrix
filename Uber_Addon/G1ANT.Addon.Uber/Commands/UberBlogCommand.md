...
## Description
This command is used to see the blog on Uber web page.
...
In the following example the browser waits until Uber webpage is loaded, After 5 second starts opening career page of Uber. after 5 second start opening Blog page on Uber:
