...
This command opens a new instance of a chrome web browser and open Uber.com in it.
...
|`url`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | no| www.uber.com | URL address of a webpage to be loaded |
...
This simple script opens chrome browser and runs a Google search for “uber”:
