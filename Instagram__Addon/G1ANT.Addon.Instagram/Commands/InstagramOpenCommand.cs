...
{
    [Command(Name = "instagram.open", Tooltip = "This command opens a new instance of a chrome web browser and open Instagram in it.")]
    class InstagramOpenCommand : Command
    {
        ...
        {
            [Argument(DefaultVariable = "Type", Tooltip = "Name of a web browser")]
