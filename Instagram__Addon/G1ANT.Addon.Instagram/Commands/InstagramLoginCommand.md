...
```G1ANT
instagram.login type ⟦username⟧ type ⟦pword⟧
```

## Description
"This command login in instagram.

| Argument | Type | Required | Default Value | Description |
| -------- | ---- | -------- | ------------- | ----------- |
|`username`| [text](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/TextStructure.md) | yes |  | Type user name |
...
In the following example the browser waits until Instagram webpage is loaded,and After 5 second starts login in Instagram acount using given credential:

```G1ANT
instagram.open 
delay 5
instagram.login username xxxxxx pword xxxx search
