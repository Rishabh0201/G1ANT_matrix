...
{
    [Command(Name = "facebook.login", Tooltip = "This command login in Facebook web browser.")]
    public class FacebookLoginCommand : Command
    {
        ...
        {
            [Argument(Required = true, Tooltip = "Enter the Login Mobile number or Email id here")]
