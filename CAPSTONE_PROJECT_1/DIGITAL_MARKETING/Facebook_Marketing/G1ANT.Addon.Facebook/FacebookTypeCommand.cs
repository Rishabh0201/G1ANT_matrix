...
{
    [Command(Name = "facebook.type", Tooltip = "This command types text into a specified element on facebook")]
    public class FacebookTypeCommand : Command
    {
        ...
        public FacebookTypeCommand(AbstractScripter scripter) : base(scripter)
        {
        }
