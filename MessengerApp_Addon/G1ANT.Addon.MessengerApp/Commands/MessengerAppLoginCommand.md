...
```G1ANT
messengerapp.login email ⟦text⟧ pass ⟦text⟧
```

## Description

This command login in the Messenger app.
...
This sample script opens Messenger app application, then login in it using given credential. After 3 seconds the robot closes the session:

```G1ANT
messengerapp.open 
messengerapp.login email xxxxx pass xxxxx
delay 3
messengerapp.close
```
